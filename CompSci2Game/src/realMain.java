...
public class realMain extends JPanel implements ActionListener {
...
/*
    ...
    private void loadImages() {
        ...
        ImageIcon iid = new ImageIcon("downloads/dot2.png");
        ball = iid.getImage();

        ImageIcon iia = new ImageIcon("downloads/apple2.png");
        apple = iia.getImage();

        ImageIcon iih = new ImageIcon("downloads/head.png");
        head = iih.getImage();
    }
